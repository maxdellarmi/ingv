...
<head>
    ...
    <script type="text/javascript" src="js/cfr.js"> </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            var objDocumentXmlString = '<?php echo $objXmlDocument ?>';

            console.log(objDocumentXmlString);

            this.parseQuakes(objDocumentXmlString);
